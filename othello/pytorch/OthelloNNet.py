...
class OthelloNNet(nn.Module):
    def __init__(self, game, args):
        ...
        self.conv1 = nn.Conv3d(1, args.num_channels, (3,3,2), stride=1, padding=1)
        self.conv2 = nn.Conv3d(args.num_channels, args.num_channels, (3,3,2), stride=1, padding=1)
        self.conv3 = nn.Conv3d(args.num_channels, args.num_channels, (3,3,2), stride=1)
